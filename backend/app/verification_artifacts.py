...
def apply(cid,event):
    ...
    for raw in extract(event):
        ...
        if kind=="remediation_candidate":
            ...
            # Validated replay persistence itself does not expose ALLOW. It must be inside the Safety Case hash first.
